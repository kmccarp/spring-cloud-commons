...
class InetUtilsTests {
	...
	@Test
	void getFirstNonLoopbackHostInfo() {
	...
	@Test
	void getFirstNonLoopbackAddress() {
		try (InetUtils utils = new InetUtils(new InetUtilsProperties())) {
	...
	@Test
	void siteLocalAddresses() throws Exception {
		InetUtilsProperties properties = new InetUtilsProperties();
	...
	@Test
	void preferredNetworksRegex() throws Exception {
		InetUtilsProperties properties = new InetUtilsProperties();
	...
	@Test
	void preferredNetworksSimple() throws Exception {
		InetUtilsProperties properties = new InetUtilsProperties();
	...
	@Test
	void preferredNetworksListIsEmpty() throws Exception {
		InetUtilsProperties properties = new InetUtilsProperties();
